...
- :heart: [Missy's Shirts](https://community.playstarbound.com/threads/migrating-xnb-mods-to-content-patcher-packs.141577/page-56#post-3303956) (For pictures check the old [Nexus](https://www.nexusmods.com/stardewvalley/mods/1523 "Missy's Shirts") page): Adds a huge ammount of shirts (and even dresses) to the game. It has a lot of unisex choices too, so it can be a good mod for any character.
- :heart: [Kisekae](https://community.playstarbound.com/threads/updating-mods-for-stardew-valley-1-3.142524/page-62#post-3330027) (For pictures check the old [Nexus](https://www.nexusmods.com/stardewvalley/mods/2348 "Kisekae") page): A very important mod that adds a dresser to your farmhouse, where you can change your appearance (same as at the wizard, but free and always available). You didn't download those hair and clothes mod to only choose one and use it during the whole playthrough, did you?
  - :broken_heart: [Get Dressed](https://www.nexusmods.com/stardewvalley/mods/331): Note that *Get Dressed* is broken, and *Kisekae* is the official replacement for it.
